...
def main():
    ...
    coverage_df = pd.DataFrame(coverage_rows).sort_values("Coverage_vs_baseline", ascending=False)
    coverage_df.to_csv(os.path.join(OUTDIR, "coverage_report.csv"), index=False)
    ...
    aligned.to_csv(os.path.join(OUTDIR, "adj_close_all_aligned.csv"), index_label="Date")
    ...
    # Exports
    out.to_csv(os.path.join(OUTDIR, "day_by_day_all.csv"), index_label="Date")
    out.loc[out["SPY_down"]].to_csv(os.path.join(OUTDIR,"day_by_day_SPY_down.csv"), index_label="Date")
    out.loc[out["QQQ_down"]].to_csv(os.path.join(OUTDIR,"day_by_day_QQQ_down.csv"), index_label="Date")
    out.loc[out["DIA_down"]].to_csv(os.path.join(OUTDIR,"day_by_day_DIA_down.csv"), index_label="Date")
    out.loc[out["IWM_down"]].to_csv(os.path.join(OUTDIR,"day_by_day_IWM_down.csv"), index_label="Date")
    out.loc[out["Both_down"]].to_csv(os.path.join(OUTDIR,"day_by_day_both_down.csv"), index_label="Date")
